...
<head>
    ...
    <style>
        ...
        .mainpage-links {
            ...
            transform: translate(-60%, -70%); /* Center both horizontally and vertically */
            display: flex;
...
<body>
    <div class="mainpage-container">
        ...
        <img src="images/download.jpg" alt="image" class="logo">
                ...
                <div class="faqContainer">
                    ...
                    <div class="home-container30">
                        ...
                        <span class="bodySmall">
                            ...
                            email to admin@assignmentportal.com. Our team will respond
