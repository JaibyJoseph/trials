...
if(isset($_POST['Update'])){
    ...
    $new_joindate = $_POST['joindate'];
    $new_teacherimg = $_POST['teacherimg'];
    ...
    phone='$new_phone',
    joindate='$new_joindate',
    teacherimg='$new_teacherimg'
    WHERE userid = '$userid' ";
  ...
  * {
  ...
  <div id="header">
    ...
    <section class="container">
      <header>Edit Teacher Details</header>
      <?php
      if(isset($_GET['userid']))
      {
        $userid = $_GET['userid'];
        $users= "SELECT * FROM teacher WHERE userid='$userid'";
        ...
        if(mysqli_num_rows($users_run) > 0)
        {
          ...
          <form action="#" class="form" method="POST">
                  <div class="input-box">
                    ...
                    <input type="text" value="<?= $user['name'];?>" name="name" style="text-transform:capitalize;" placeholder="Enter full name" required />
                  </div>

                  <div class="input-box">
                    <label>Email Address</label>
                    <input type="text" value="<?= $user['mail'];?>" name="mail" placeholder="Enter email address" required />
                  </div>
                  ...
                  <div class="column">
                    ...
                    <div class="input-box">
                      ...
                      <input type="date" value="<?= $user['joindate'];?>" name="joindate" placeholder="Enter join date" required />
                    </div>
                  </div>
                    ...
                    <div class="column">
                      ...
                      <div class="select-box">
                        <select name="role" required>
                          ...
                          <option value="Teaching Assistant" <?= $user['role'] == 'Teaching Assistant' ? 'selected':'' ?> >Teaching Assistant</option>
                          <option value="Assistant Professor" <?= $user['role'] == 'Assistant Professor' ? 'selected':'' ?> >Assistant Professor</option>
                        </select>
                      </div>
                    </div>
                    <div class="column">
                      <input type="text" value="<?= $user['branch_id'];?>" name="branch_id" placeholder="Enter branch id" required />
                      <input type="file" value="<?= $user['teacherimg'];?>" accept="image/*" id="img" name="teacherimg" placeholder="Enter teacher image" required />
                    </div>
                    <div class="column">
                      <input type="text" value="<?= $user['userid'];?>" name="userid" style="text-transform:capitalize;" placeholder="Enter user id" readonly />
