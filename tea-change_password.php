...
if(isset($_POST['change'])) { // upon clicking the change button in stu-cp
    $mail = $_POST['mail']; //email from rmail i/p field in stu-change_password.php
    $new_password = $_POST['pass']; //new password from stu-change_password file,pw input field

    $changeQuery = $con->query("UPDATE teacher SET pass = '$new_password' WHERE mail = '$mail'");
    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="stdlogin" action="" method="POST">
                ...
                <div class="email">
                    <input type="email" id="email" name="mail" placeholder="User ID" required>
