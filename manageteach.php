  ...
  * {
  ...
  <div id="header">
    ...
    <?php if (isset($message)): ?>
        <p style="color:black; top:50%; left:50%;"><?php echo "Teacher added successfully!"; ?></p>
    <?php endif; ?>

    <div id="adding">
        <a href="addteachers.php">
            <span>&plus; ADD NEW TEACHER</span>
        </a>
    </div>
                ...
                while ($result = mysqli_fetch_assoc($run)) {  
                     echo "  
                          <tr class='data'>  
                               ...
                               <td>".$result['userid']."</td>  
                               <td>".$result['name']."</td>
                               <td><a href='viewteacher.php?userid=".$result['userid']."' id='btn'>View profile</a></td>
                               <td><a href='delete.php?userid=".$result['userid']."' id='btn'>Delete</a></td>  
                          </tr>  
                     ";  
                }  
           }  
