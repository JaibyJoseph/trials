...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT * FROM teacher WHERE mail='$email' AND pass='$pass'";
    ...
    if ($result->num_rows > 0) {
        ...
        $_SESSION['teacherimg']=$user['teacherimg'];
    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="stdlogin" action="" method="POST">
                <h1>Login</h1>
                <div class="email">
                    <input type="text" id="admin_email" name="mail" placeholder="User ID" required>
                ...
                <p><a href="tea-change_password.php" class="forgot-password-link">Forgot Password?</a></p>
            </form>
        </div>
        <div class="footer">
